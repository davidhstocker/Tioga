        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    worker = Worker(workerapi, actionInvocation.masterLandmarkUUID, self.commQueue, self.actionIndex)
                    worker.dQueue.append( actionInvocation )
                    worker.start()
                    ...
                    if len(self.depricatedWorkerQueues[worker.queueID]) > 1:
                        ...
                        try:
                            if len(self.depricatedWorkerQueues[worker.queueID]) > 0:
                                ...
                                workerapi = copy.deepcopy(self.script)
                                newWorker = Worker(workerapi, worker.queueID, self.commQueue, self.actionIndex)
